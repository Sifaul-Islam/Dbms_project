...
<head>
  ...
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <title>পণ্য ট্র্যাকিং - বিতরণকারী</title>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: auto;">
            <ul class="navbar-nav">
                ...
                <!-- Product Tracking -->
                <li class="nav-item">
                    <a class="nav-link active" href="./বিতরণকারী পণ্য ট্র্যাকিং.html">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <!-- Data Reports -->
                <li class="nav-item">
                    <a class="nav-link" href="./বিতরণকারী প্রতিবেদন এবং বিশ্লেষণ.html">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0 d-flex justify-content-between">
                            <h6>পণ্যের তালিকা</h6>
                            <a class="btn btn-sm btn-success" href="addpd.php">নতুন পণ্য যোগ করুন</a>
                        </div>
...
?>
        ...
        <a class="btn btn-sm btn-primary edit-btn" href="updatept.php?Product_Name=<?php echo $row['Product_Name']; ?>">
            সম্পাদনা
        </a>
        <button 
...
<script>
    ...
    function confirmDelete(Product_Name, productName) {
        ...
        const deleteUrl = `বিতরণকারী প্রতিবেদন এবং বিশ্লেষণ.php?Product_Name=${Product_Name}`;
