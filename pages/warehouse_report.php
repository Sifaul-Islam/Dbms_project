...
if (isset($_GET['barcode'])) {
    ...
    if ($stmt->execute()) {
        header("Location: warehouse_report.php?success=1");
        exit;
    } else {
...
<head>
  ...
  <title>প্রতিবেদন এবং বিশ্লেষণ - Reports & Analytics</title>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: auto;">
            <ul class="navbar-nav">
                ...
                <!-- Product Tracking -->
                <li class="nav-item">
                    <a class="nav-link" href="../pages/warehouse_product_tracking.php">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <!-- Data Reports -->
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/warehouse_report.php">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between">
                <h6>পণ্যের তালিকা</h6>
                <a class="btn btn-sm btn-success" href="addwr.php">নতুন পণ্য যোগ করুন</a>
            </div>
...
<script>
    ...
    function confirmDelete(barcode, productName) {
        ...
        const deleteUrl = `warehouse_report.php?barcode=${barcode}`;
